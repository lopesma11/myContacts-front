...
5%, 95% {box-shadow: 0 -0.83em 0 -0.4em, 0 -0.83em 0 -0.42em, 0 -0.83em 0 -0.44em,
    0 -0.83em 0 -0.46em, 0 -0.83em 0 -0.477em;
}
10%, 59% {
...
20% {
    ...
    -0.617em -0.488em 0 -0.46em, -0.749em -0.34em 0 -0.477em;
}
38% {
...
export const Overlay = styled.div`
    ...
    top: 0;
    left: 0;
    background: rgba(246, 252, 252, 0.7);
    align-items: center;
    ...
    .loader {
        ...
        animation: ${load} 1.7s infinite ease, ${round} 1.7s infinite easee;
    }
`;
